  ...
  return h(Dropdown, {
    ...
    h(
      DropdownMenuItem,
      {
        key: 'shasta',
        closeMenu: () => this.props.hideNetworkDropdown(),
        onClick: () => props.setProviderType('shasta'),
        style: dropdownMenuItemStyle,
      },
      [
        providerType === 'shasta' ? h('i.fa.fa-check') : h('.network-check__transparent', '✓'),
        h(NetworkDropdownIcon, {
          backgroundColor: '#f6c343', // $saffron
          isSelected: providerType === 'shasta',
        }),
        h('span.network-name-item', {
          style: {
            color: providerType === 'shasta' ? '#ffffff' : '#9b9b9b',
          },
